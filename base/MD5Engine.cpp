...
const DigestEngine::Digests& MD5Engine::Digest()
{
...
void MD5Engine::encode(unsigned char* output, const uint32_t* input, unsigned int len)
{
	unsigned int i, j;
...
void MD5Engine::decode(uint32_t* output, const unsigned char* input, unsigned int len)
{
	unsigned int i, j;
